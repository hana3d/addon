...
class Query(object):  # noqa : WPS230,WPS214
    ...
    def __init__(self, context: Context, search_props: Props = None):
    ...
    def _add_view_id_search_term(self, search_props: Props):
    ...
    def _add_tags(self, search_props: Props):
        tags = []
    ...
    def _add_libraries(self, search_props: Props):
        libraries = []
