...
get_audience_url = paths.get_audience_url
get_api_url = paths.get_api_url
get_addon_name = paths.get_addon_name
...
def write_tokens(oauth_response: dict):
    preferences = bpy.context.preferences.addons[get_addon_name()].preferences
